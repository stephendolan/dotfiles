...
2. If $ARGUMENTS contains a Linear issue ID or URL, fetch details via Linear MCP
...
This phase prevents wasted implementation effort. Complete it before designing.
