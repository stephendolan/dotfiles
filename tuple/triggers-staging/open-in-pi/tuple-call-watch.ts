...
const WATCH_TIMINGS: Record<WatchMode, WatchTiming> = {
  realtime: { pollMs: 200, quietMs: 700, maxWaitMs: 4000, description: "fastest, for pair programming or troubleshooting" },
  balanced: { pollMs: 1000, quietMs: 2000, maxWaitMs: 12000, description: "for normal meetings and onboarding calls" },
